...
export default function Portfolio() {
  ...
  return (
    <section id="achievements" className="bg-[#0a0a0a] text-white py-16 px-6 md:px-12 lg:px-24">
      ...
      <section className="bg-[#0a0a0a] text-white py-16 px-6 md:px-12 lg:px-24">
          ...
          <div className="relative border-l-2 border-pink-500 pl-6">
            {educationData.map((edu, index) => (
              <motion.div
                ...
                className="bg-[#1a1a1a] p-6 rounded-lg shadow-md hover:bg-[#222] transition-all mb-6 relative"
              >
      ...
      <section>
        <h2 className="text-4xl font-bold text-center mt-16">My Certifications</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          {certifications.map((cert, index) => (
            <div
              key={index}
              className="bg-[#1a1a1a] p-6 rounded-xl shadow-lg text-center flex flex-col items-center"
            >
